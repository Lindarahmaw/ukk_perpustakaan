                                ...
                                <div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6 items">
                                    <div class="card contact-bx item-content">
                                        ...
                                        <div class="card-body user-profile">
                                            <div class="image-bx">
                                                <img src="<?= $data['img'] ?>" data-src="images/contacts/Untitled-3.jpg"
                                                    alt="">
                                            ...
                                            <div class="media-body user-meta-info">
                                                ...
                                                <ul>
                                                    ...
                                                    <div class="container mt-5">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-primary btn-rounded fs-18" data-bs-toggle="modal"
                                                    ...
                                                    <div class="container mt-5">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-primary btn-rounded fs-18" data-bs-toggle="modal"
                                                            data-bs-target="#reviewModal" <?= $data['buku_id'] ?>>+ Beri
                                                            Ulasan</a>
                                                    </div>
