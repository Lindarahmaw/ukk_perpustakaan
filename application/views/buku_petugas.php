...
<body>
            ...
            <div class="header-content">
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <a href="<?php echo site_url('auth/logout2'); ?>" class="btn btn-danger">Logout</a>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="" href="<?= base_url('dash_petugas/') ?>" aria-expanded="false">
                ...
                <li><a class="" href="<?= base_url('buku_petugas/') ?>">
                        <i class="fa-solid fa-book"></i>
                        <span class="nav-text">Buku</span>
                    </a>

                </li>
                <li><a class="" href="<?= base_url('kategori_buku/') ?>">
                ...
                <li><a class="" href="<?= base_url('Peminjaman/') ?>">
                ...
                <li><a class="" href="<?= base_url('denda_petugas/') ?>">
                    ...
                    <div class="col-lg-12">
                        <div class="container mt-5">
                            <a href="javascript:void(0);" class="btn btn-primary btn-rounded fs-18"
                                ...
                                style="position:relative; margin: 1rem; right: -70rem;">+ Tambah</a>
                        </div>
                        <div class="modal fade" id="bukuModal" tabindex="-1" aria-labelledby="pinjamModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="pinjamModalLabel">Form Tambah Buku</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="<?= base_url('Tambah_Buku') ?>" method="post"
                                            enctype="multipart/form-data">
                                            <div class="mb-3">
                                                <label for="tanggalPinjam" class="form-label">Img</label>
                                                <input type="text" class="form-control" id="tanggalPinjam" name="img"
                                                    required>

                                            </div>
                                            <div class="mb-3">
                                                <label for="tanggalKembali" class="form-label">Judul</label>
                                                <input type="text" class="form-control" id="tanggalKembali" name="judul"
                                                    required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="tanggalKembali" class="form-label">Judul</label>
                                            ...
                                            <div class="mb-3">
                                                <label for="tanggalKembali" class="form-label">Penulis</label>
                                                <input type="text" class="form-control" id="tanggalKembali"
                                                    name="penulis" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="tanggalKembali" class="form-label">Penerbit</label>
                                                <input type="text" class="form-control" id="tanggalKembali"
                                                    name="penerbit" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="tanggalKembali" class="form-label">Description</label>
                                                <input type="text" class="form-control" id="tanggalKembali"
                                                    name="description" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="tanggalKembali" class="form-label">Code</label>
                                                <input type="text" class="form-control" id="tanggalKembali" name="code"
                                                    required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="tanggalKembali" class="form-label">Tahun
                                                    Terbit</label>
                                                <input type="text" class="form-control" id="tanggalKembali"
                                                    name="tahun_terbit" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="tanggalKembali" class="form-label">Jumlah</label>
                                                <input type="text" class="form-control" id="tanggalKembali"
                                                    name="jumlah" required>
                                            </div>
                                            <!-- <div class="mb-3">
                                                <input type="hidden" class="form-control" id="peminjam_id"
                                                    name="peminjam_id" required>
                                            </div>
                                            <div class="mb-3">
                        ...
                        <div class="card">
                                    ...
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody id="customers">
                                            <?php foreach ($datas as $data): ?>
                                                <tr>
                                                    <td><img class="rounded-circle" width="35" src="<?= $data['img'] ?>"
                                                            alt=""></td>
                                                    <td><?= $data['judul'] ?></td>
                                                    <td><?= $data['nama_kategori'] ?></td>
                                                    <td><a href="mailto:ricky@example.com"><?= $data['penulis'] ?></a>
                                                    </td>
                                                    <td><a href="tel:2012001851"><?= $data['penerbit'] ?></a></td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="#" class="btn btn-primary shadow btn-xs sharp me-1"><i
                                                                    ...
                                                                    data-bs-target="#Edit_buku<?= $data['buku_id'] ?>"></i></a>
                                                            <a href="#" onclick="deleteConfirm(<?= $data['buku_id'] ?>)"
                            ...
                            </div><?php foreach ($datas as $data): ?>
                                <div class="modal fade" id="Edit_buku<?= $data['buku_id'] ?>" tabindex="-1"
                                    aria-labelledby="pinjamModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="pinjamModalLabel">Form Edit Buku</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form action="<?= base_url('update_buku/') . $data['buku_id'] ?>"
                                                    method="post" enctype="multipart/form-data">
                                                    <div class="mb-3">
                                                        <label for="tanggalPinjam" class="form-label">Img</label>
                                                        <input type="text" class="form-control" value="<?= $data['img'] ?>"
                                                            id="tanggalPinjam" name="img" required>

                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="tanggalKembali" class="form-label">Judul</label>
                                                        <input type="text" class="form-control"
                                                            value="<?= $data['judul'] ?>" id="tanggalKembali" name="judul"
                                                            required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="tanggalKembali" class="form-label">Kategori</label>
                                                        <select name="id_kategori" id="kategori">
                                                            <option value="">Pilih Kategori</option>
                                                            <?php foreach ($kategori as $kat): ?>
                                                                <option value="<?= $kat['id_kategori'] ?>"
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="tanggalKembali" class="form-label">Penulis</label>
                                                        <input type="text" class="form-control"
                                                            value="<?= $data['penulis'] ?>" id="tanggalKembali"
                                                            name="penulis" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="tanggalKembali" class="form-label">Penerbit</label>
                                                        <input type="text" class="form-control"
                                                            value="<?= $data['penerbit'] ?>" id="tanggalKembali"
                                                            name="penerbit" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="tanggalKembali" class="form-label">Description</label>
                                                        <input type="text" class="form-control"
                                                            value="<?= $data['description'] ?>" id="tanggalKembali"
                                                            name="description" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="tanggalKembali" class="form-label">Code</label>
                                                        <input type="text" class="form-control" value="<?= $data['code'] ?>"
                                                            id="tanggalKembali" name="code" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="tanggalKembali" class="form-label">Tahun
                                                            Terbit</label>
                                                        <input type="text" class="form-control"
                                                            value="<?= $data['tahun_terbit'] ?>" id="tanggalKembali"
                                                            name="tahun_terbit" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="tanggalKembali" class="form-label">Jumlah</label>
                                                        <input type="text" class="form-control"
                                                            value="<?= $data['jumlah'] ?>" id="tanggalKembali" name="jumlah"
                                                            required>
                                                    </div>
                                                    <!-- <div class="mb-3">
                                                <input type="hidden" class="form-control" id="peminjam_id"
    ...
    ***********************************-->
        ...
        function deleteConfirm(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "<?= base_url('Delete_buku/') ?>" + id;
                }
            });
        }
    </script>
    ...
    <script src="<?= base_url('assets/dashboard') ?>/vendor/chart.js/Chart.bundle.min.js"></script>
    <!-- Apex Chart -->
    <script src="<?= base_url('assets/dashboard') ?>/vendor/apexchart/apexchart.js"></script>

    <script src="<?= base_url('assets/dashboard') ?>/vendor/highlightjs/highlight.pack.min.js"></script>
    <!-- Circle progress -->
    ...
    <script src="<?= base_url('assets/dashboard') ?>/js/plugins-init/datatables.init.js"></script>
