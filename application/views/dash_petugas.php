		...
		***********************************-->
		<div class="dlabnav">
			<div class="dlabnav-scroll">
				...
				<li><a class="" href="<?= base_url('Peminjaman/') ?>" aria-expanded="false">
									...
									<table class="table table-sm mb-0 table-striped">
										<thead>
											<tr>
												...
												<th>Email</th>
												<th>Passwoard</th>
												<th class=" ps-5" style="min-width: 200px;">Alamat
												</th>
												<th>Phone</th>
												<th></th>
											</tr>
															...
															<div class="media d-flex align-items-center">
																<div class="avatar avatar-xl me-2">
																	<div class=""><img class="rounded-circle img-fluid"
																			src="<?= base_url("assets/image/") . $data['image'] ?>"
																			width="30" alt="">
																	</div>
																</div>
																<div class="media-body">
																	<h5 class="mb-0 fs--1"><?= $data['nama_lengkap'] ?></h5>
																</div>
															</div>
														</a>
													</td>
													<td class="py-2"><a
															href="mailto:ricky@example.com"><?= $data['email'] ?></a>
													</td>
													<td class="py-2"> <a href="tel:2012001851"><?= $data['password'] ?></a>
													</td>
													<td class="py-2 ps-5"><?= $data['alamat'] ?></td>
													<td class="py-2"><?= $data['phone'] ?></td>
