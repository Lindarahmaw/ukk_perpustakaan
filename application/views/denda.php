                ...
                <div class="row">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?= base_url('Peminjaman/') ?>" method="post"
                                        ...
                                        <div class="mb-3">
                                            <label for="tanggalPinjam" class="form-label">Nama</label>
                                            <input type="text" class="form-control" id="tanggalPinjam" name="nama"
                                                required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="tanggalKembali" class="form-label">Buku</label>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Informasi Denda </h4>
                        </div>
                        <!-- <div class="container mt-5"> -->
                        <!-- </div> -->
                        <div class="card-body">
                                    ...
                                    <tbody id="customers">
                                        <?php foreach ($datas as $data): ?>
                                            <tr>
                                                ...
                                                <td><?= $data['judul'] ?></td>
                                                <td><a
                                                        href="mailto:ricky@example.com"><?= $data['tanggal_dikembalikan'] ?></a>
                                                </td>
                                                <td><a href="tel:2012001851">Rp <?= $data['nominal'] ?></a>
                                                </td>
                                                <td><?= $data['status'] ?></td>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="#" class="btn btn-primary shadow btn-xs sharp me-1"><i
                                                                ...
                                                                data-bs-target="#Edit_denda<?= $data['peminjaman_id'] ?>"></i></a>
                                                        <a href="#" onclick="deleteConfirm(<?= $data['peminjaman_id'] ?>)"
                        ...
                        <?php foreach ($datas as $data): ?>
                            <div class="modal fade" id="Edit_denda<?= $data['peminjaman_id'] ?>" tabindex="-1"
                                aria-labelledby="pinjamModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="pinjamModalLabel">Form Denda</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form action="<?= base_url('Denda/') ?>" method="post"
                                                enctype="multipart/form-data">
                                                <div class="mb-3">
                                                    <label for="tanggalPinjam" class="form-label">Status</label>
                                                    <select name="status" id="status" class="form-select" required>
                                                        <option value="belum_dibayar" <?= ($data['status'] == 'belum_dibayar') ? 'selected' : '' ?>>belum_dibayar</option>
                                                        <option value="sudah_dibayar" <?= ($data['status'] == 'sudah_dibayar') ? 'selected' : '' ?>>sudah_dibayar</option>
                                                    </select>
                                                    <input type="hidden" value="<?= $data['peminjaman_id'] ?>"
                                                        name="peminjaman_id">
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
        ...
        function deleteConfirm(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "<?= base_url('Delete_denda/') ?>" + id;
                }
            });
        }
    </script>
