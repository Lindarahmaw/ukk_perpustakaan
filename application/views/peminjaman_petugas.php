        ...
        ***********************************-->
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                ...
                <li><a class="" href="<?= base_url('buku_petugas/') ?>" aria-expanded="false">
                ...
                <div class="row">
                                ...
                                <div class="modal-body">
                                    <form action="<?= base_url('Tambah_Buku') ?>" method="post"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="tanggalKembali" name="penulis"
                                                required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="tanggalKembali" class="form-label">Penerbit</label>
                                            <input type="text" class="form-control" id="tanggalKembali" name="penerbit"
                                                required>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="tanggalKembali" name="jumlah"
                                                required>
                                        </div>
                                        <!-- <div class="mb-3">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <table id="example3" class="display" style="min-width: 845px">
                                    ...
                                    <tbody id="customers">
                                        <?php foreach ($datas as $data): ?>
                                            <tr>
                                                <td><img class="rounded-circle" width="35" src="<?= $data->img ?>" alt="">
                                                </td>
                                                <td><?= $data->judul ?></td>
                                                <td><?= $data->nama_lengkap ?></td>
                                                <td><a href="mailto:ricky@example.com"><?= $data->tanggal_peminjaman ?></a>
                                                </td>
                                                <td><a href="tel:2012001851"><?= $data->tanggal_pengembalian ?></a>
                                                </td>
                                                <td><?= $data->status ?></td>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="#" class="btn btn-primary shadow btn-xs sharp me-1"><i
                                                                ...
                                                                data-bs-target="#Edit_peminjaman<?= $data->peminjaman_id ?>"></i></a>
                            ...
                            <?php foreach ($datas as $data): ?>
                                <div class="modal fade" id="Edit_peminjaman<?= $data->peminjaman_id ?>" tabindex="-1"
                                    aria-labelledby="pinjamModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="pinjamModalLabel">Form Edit Peminjaman</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form action="<?= base_url('update_peminjaman/' . $data->peminjaman_id) ?>"
                                                    ...
                                                    <!-- Jika Anda ingin menyertakan ID peminjaman atau informasi lain, Anda bisa menambahkannya di sini -->
        ...
        function deleteConfirm(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "<?= base_url('Delete_peminjaman/') ?>" + id;
                }
            });
        }
    </script>
