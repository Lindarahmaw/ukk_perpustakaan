                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="pinjamModalLabel">Form Tambah Data</h5>
                                    ...
                                    <div class="modal-body">
                                        <form action="<?= base_url('Tambah_User') ?>" method="post"
                                            ...
                                            <div class="mb-3">
                                                <label for="tanggalKembali" class="form-label">Nama Lengkap</label>
                                                <input type="text" class="form-control" id="tanggalKembali"
                                                    name="nama_lengkap" required>
                                            </div>

                                            <div class="mb-3">
                                                <label for="tanggalKembali" class="form-label">Email</label>
                                                <input type="text" class="form-control" id="tanggalKembali" name="email"
                                                    required>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <label for="tanggalKembali" class="form-label">Password</label>
                                                <input type="password" class="form-control" id="tanggalKembali"
                                            ...
                                            <div class="mb-3">
                                                <label for="tanggalKembali" class="form-label">Date Created</label>
